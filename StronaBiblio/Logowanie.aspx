...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        <tr>
            <td><strong>Witaj w klubie miłośników taniej literatury</strong></td>
            <td><strong></strong></td>
        </tr>
        <tr>
            <td>    <asp:Login ID="Login1" runat="server" BackColor="#EFF3FB" BorderColor="#B5C7DE" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" FailureText="Logowanie nieudane, spróbuj ponownie" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#333333" LoginButtonText="Zaloguj" OnAuthenticate="Login1_Authenticate" PasswordLabelText="Hasło:" PasswordRequiredErrorMessage="Hasło jest wymagane" RememberMeText="Zapamiętaj mnie" TitleText="Logowanie" UserNameLabelText="Email:" UserNameRequiredErrorMessage="Musisz podac email" Width="368px" DestinationPageUrl="start.aspx">
